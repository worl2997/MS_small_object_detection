    ...
    def forward(self, x):
        ...
        for idx, (lateral_conv, output_conv) in enumerate(
            ...
            if idx > 0:
                ...
                if idx==1:
                    prev_features = top_down_features + self.ms_cam1(lateral_features)
                elif idx ==2 :
                    prev_features = top_down_features + self.ms_cam2(lateral_features)
        ...
        '''
        # SFF 적용 -> 에러있음 
        level_0 = self.level_0_fusion(results[2],results[1], results[0]) #작은크기 피쳐
        level_1 = self.level_1_fusion(results[2],results[1], results[0])
        level_2 = self.level_2_fusion(results[2],results[1], results[0]) #큰 크기 피쳐
        results[2] = level_0
        results[1] = level_1
        results[0] = level_2
...
class ASFF(nn.Module):
    def __init__(self, level, rfb=False, vis=False):
        ...
        self.level = level
        self.dim = [256, 256, 256] #[512, 256, 256]
