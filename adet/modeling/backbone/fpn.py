...
from .mcf_resnet import build_mcf_resnet_backbone
from detectron2.layers import ShapeSpec
from detectron2.modeling.backbone.build import  BACKBONE_REGISTRY
from .myfpn import FPN_DSPP
...
def build_fcos_resnet_fpn_backbone(cfg, input_shape: ShapeSpec):
    ...
    if cfg.MODEL.BACKBONE.ANTI_ALIAS:
        ...
        print('is this mcf resnet backbone??')
        bottom_up = build_mcf_resnet_backbone(cfg, input_shape)
